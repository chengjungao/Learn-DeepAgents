...
1. **search_local_notes**: Keyword search over the user's own notes and project docs. Offline, free, and returns file paths plus line numbers
2. **read_local_note**: Open one local note in full, with line slicing
